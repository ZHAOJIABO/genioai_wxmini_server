...
################################################################################
# GenioAI Backend 一键部署脚本
# 用途：当代码更新后，自动拉取、构建、部署新版本
################################################################################
...
case "${1:-}" in
    ...
    --help)
        ...
        echo "  ./deploy.sh --rollback - 回滚到上一个版本"
