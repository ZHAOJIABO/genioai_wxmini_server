...
const (
	EventService_IngestEvent_FullMethodName = "/events.v1.EventService/IngestEvent"
	EventService_IngestBatch_FullMethodName = "/events.v1.EventService/IngestBatch"
)
...
func (c *eventServiceClient) IngestEvent(ctx context.Context, in *IngestEventRequest, opts ...grpc.CallOption) (*IngestEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, EventService_IngestEvent_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventServiceClient) IngestBatch(ctx context.Context, in *IngestBatchRequest, opts ...grpc.CallOption) (*IngestBatchResponse, error) {
	...
	err := c.cc.Invoke(ctx, EventService_IngestBatch_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
